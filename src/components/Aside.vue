...
<template>
    <el-aside :width="asideWidth">   
           <div style="height: 60px; line-height: 60px; font-size: 20px; display: flex; align-items: center; justify-content: center">
             <img :src="require('@/assets/images/vegetable.png')" style="width: 30px;" alt="">
             <span class="logo-title" v-show="!isCollapse">供应管理</span>
           </div>
           <el-menu router :collapse="isCollapse" :collapse-transition="false" background-color="#001529"
             ...
             <el-submenu index="3">
               ...
               <el-menu-item index="/work">商品供应商</el-menu-item>
               <el-menu-item index="/rest">商品库存</el-menu-item>
             </el-submenu>
           </el-menu>
         </el-aside>
   </template>
